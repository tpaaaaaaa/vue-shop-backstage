    ...
    <div>
        ...
        <el-table border stripe :data="records">
            ...
            <el-table-column prop="prop" label="操作" width="300">
                <template slot-scope="{row,$index}">
                    <el-button v-if="!row.isSale" type="success" size="mini" icon="el-icon-sort-up"
                               @click="onsale(row)">
                    </el-button>
        ...
        <el-drawer
            ...
            <el-row>
                ...
                <el-col :span="16">
                    <el-tag v-for="saleAttr of skuInfo.skuSaleAttrValueList" type="success" size="mini"
                            :key="saleAttr.id">
            ...
            <el-row>
                ...
                <el-col :span="16">
                    <el-carousel height="150px" direction="horizontal"
