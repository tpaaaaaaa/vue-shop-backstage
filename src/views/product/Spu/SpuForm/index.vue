...
export default {
  ...
  methods: {
    ...
    addSaleAttr() {
      ...
      if (this.spu.spuSaleAttrList.some(item => item.saleAttrName === newSaleAttr.saleAttrName)) { return this.$message('已经添加了该属性哦') }
    ...
    handleInputConfirm(row) {
      ...
      // 判断重复
      const re = row.spuSaleAttrValueList.some(item => item.saleAttrValueName === inputValue)
